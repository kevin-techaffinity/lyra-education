            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="login-descrp text-start">
                  ...
                  <h4>Reliable Software Advice</h4>
                  <p>
                    Thanks to Life Space, I was able to discover the perfect match and
                    guidance that will help in aligning perfectly my life choices and
                    know the requirements. Highly recommended!
                  </p>
                  <p className="author-name">
                    - Tod Cunningham, <span>Health Care Support</span>
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="login-details text-start">
                  ...
                  <div className="form-container">
                    <h4>Welcome to Life Space, You get all in one place</h4>
                    <form
                      ref={formRef}
